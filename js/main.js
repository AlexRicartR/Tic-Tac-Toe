...
function resetgame() {
	...
	document.getElementById("writePlayersNames").setAttribute("hidden", "khidden");
	document.getElementById("player1askname").setAttribute("hidden", "khidden");
	document.getElementById("player2askname").setAttribute("hidden", "khidden");
	document.getElementById("whoBeginsScreen").setAttribute("hidden", "khidden");
	document.getElementById("msgplaceholder").setAttribute("hidden", "khidden");
